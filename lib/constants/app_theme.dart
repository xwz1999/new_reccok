...
import 'package:new_recook/base/base_style.dart';

class AppTheme {
  static ThemeData get theme {
    return ThemeData(primarySwatch: Colors.red).copyWith(
      primaryColor: BaseStyle.themeColor,
      ...
      iconTheme: IconThemeData(color: BaseStyle.themeColor),
      ...
      radioTheme: RadioThemeData(
        fillColor: MaterialStateProperty.resolveWith<Color?>((states) {
          if (states.contains(MaterialState.selected)) return BaseStyle.themeColor;
          return null;
        }),
      ),
      ...
      textButtonTheme: TextButtonThemeData(
        style: ButtonStyle(
          overlayColor: MaterialStateProperty.resolveWith((states) {
            if (states.contains(MaterialState.disabled))
              return Color(0xFFFFF4D7);
            return BaseStyle.themeColor.withOpacity(0.2);
          }),
          foregroundColor: MaterialStateProperty.resolveWith((states) {
            if (states.contains(MaterialState.disabled))
              return Color(0xFF666666);
      ...
      dividerColor: Color(0xFFE8E8E8), colorScheme: ColorScheme.fromSwatch().copyWith(secondary: BaseStyle.themeColor),
    );
  }
}
...
class SystemStyle {
  ...
  static const yellowBottomBar = SystemUiOverlayStyle(
    statusBarIconBrightness: Brightness.light,
    systemNavigationBarColor:BaseStyle.themeColor,
  );
